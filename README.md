...
<div align="center">
  <a href="https://linkedin.com/in/Wesleyharuo">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white"/>
  </a>
  <a href="mailto:wesley_haruo@gmail.com">
    <img src="https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white"/>
  </a>
  <a href="https://github.com/wesleyharuo">
...
|----------|-------------|-------|
| **Data Analytics** | Pandas, NumPy, Matplotlib, Seaborn, Plotly | ████████████ 95% |
| **Machine Learning** | Scikit-learn, XGBoost, LightGBM, TensorFlow | ████████████ 90% |
| **Backend** | Python, Flask, FastAPI, Node.js | ████████████ 88% |
| **Data Engineering** | Streamlit, SQL, ETL Pipelines | ████████████ 85% |
| **Frontend** | React, TypeScript, HTML/CSS, Tailwind CSS | ████████████ 82% |
...
### ⚙️ Process Improvement Analytics Platform
**Repository:** [wesleyharuo/Process-Improvement-Data-Analytics-Platform](https://github.com/wesleyharuo/Process-Improvement-Data-Analytics-Platform) | **Status:** ✅ Public

**Tech Stack:** Python · Streamlit · Pandas · NumPy · Plotly · SQL
...
**Repository:** [wesleyharuo/Predicta_Suite](https://github.com/wesleyharuo/Predicta_Suite) | **Status:** ✅ Public

**Tech Stack:** Python · Scikit-learn · Prophet · ARIMA · Matplotlib · Plotly · Seaborn · Pandas · NumPy
...
**Repository:** [wesleyharuo/AI-Fraud-Detection-Canada](https://github.com/wesleyharuo/AI-Fraud-Detection-Canada) | **Status:** ✅ Public

**Tech Stack:** Python · Neural Networks · Ensemble Methods · Microservices
...
**Tech Stack:** HTML · Vercel

**What it does:**  
AI-focused web dashboard deployed on Vercel. Features an intelligence dashboard interface for interacting with and visualizing AI capabilities.
...
**Tech Stack:** HTML · OpenRouter API · Vercel

**What it does:**  
Lightweight web-based AI copilot tool integrating with OpenRouter for multi-model AI access. Single-file deployment on Vercel for instant availability.
...
**What it does:**  
Web-based file serving and management system backed by a Railway PostgreSQL database. Provides file storage, retrieval, and management through a browser-based interface.

**Components:**
- `backend_files.php` — File management backend logic
- `file_server_complete.html` — Web UI for file operations
- `railway_database_config.php` — Railway DB connection configuration
- `railway_index.php` — Application entry point
...
**What it does:**  
Frontend landing page and web interface for the Process Improvement Analytics Platform. Provides a browser-based entry point to the operational dashboards and analytics tools.
...
## 🗂️ All Projects — Quick Reference

| Project | Category | Stack | Link |
|---------|----------|-------|------|
| Maple Outfitters | Data Analytics | Python | [↗](https://github.com/wesleyharuo/maple-outfitters) |
| GTA Rental Market | Data Analytics | Python | [↗](https://github.com/wesleyharuo/gta-rental-market) |
| Maple Cafe Sales | Data Analytics | Python | [↗](https://github.com/wesleyharuo/maple-cafe-sales) |
| Process Improvement Platform | BI / Dashboards | Python + Streamlit | [↗](https://github.com/wesleyharuo/Process-Improvement-Data-Analytics-Platform) |
| Predicta Suite | Time Series ML | Python | [↗](https://github.com/wesleyharuo/Predicta_Suite) |
| Model Dig MKT | Marketing Analytics | Python + Flask | [↗](https://github.com/wesleyharuo/Model_Dig_MKT) |
| QuickStats Web | Statistics | HTML / JS | [↗](https://github.com/wesleyharuo/QuickStats-Web) |
| CardGuard | Fraud Detection ML | Python + Docker | [↗](https://github.com/wesleyharuo/CardGuard-) |
| AI Fraud Detection Canada | Fraud Detection ML | Python | [↗](https://github.com/wesleyharuo/AI-Fraud-Detection-Canada) |
| Insurance ML | Predictive Modeling | Python + Flask | [↗](https://github.com/wesleyharuo/Data_insurance_IA_ML_Insurance) |
| KW Risk | Insurance AI | React + FastAPI | [↗](https://github.com/wesleyharuo/KW_Risk) |
| Aplicaton-new | SaaS / Full-stack | TypeScript | [↗](https://github.com/wesleyharuo/Aplicaton-new) |
| AI Hub | AI Dashboard | HTML | [↗](https://github.com/wesleyharuo/AI-hub) |
| Cop | AI Copilot Tool | HTML | [↗](https://github.com/wesleyharuo/cop) |
| DigitalMenuHub | Restaurant Tech | HTML / JS | [↗](https://github.com/wesleyharuo/DigitalMenuHub) |
| Lex | File Server | HTML + PHP | [↗](https://github.com/wesleyharuo/lex) |
| Process-Improvemen | Web Interface | HTML | [↗](https://github.com/wesleyharuo/Process-Improvemen) |
| Calc Vector | STEM Education | Python + Streamlit | [↗](https://github.com/wesleyharuo/Calc_Vector) |
...
<img src="https://skillicons.dev/icons?i=python,javascript,typescript,html,css,sql&theme=dark" />

**Frameworks & Libraries**

<img src="https://skillicons.dev/icons?i=react,nextjs,nodejs,flask,fastapi,streamlit&theme=dark" />
